...
INSERT INTO category (`id`, `title`, `meta_chunks`, `negative_meta_chunks`, `suggested_values`,`suggested_values_reason`,`sort_order`, `ai_id`) VALUES
('05307130-62a2-498d-8dd1-dc56a79dab36', 'Style', '{}', '{}', 1, 'You only really want one style', 1, '3a5a0b0d-0cdc-4000-bbf4-d7eb91d0b6ff'),
('7ff59fd0-320c-405d-afda-26684f4873f3', 'Medium', '{}', '{}', 1, 'You only really want one medium', 2, '3a5a0b0d-0cdc-4000-bbf4-d7eb91d0b6ff'),
('e58b44fd-552e-43f5-a21a-a1e5d84c631f', 'Artist', '{}', '{}', 2, 'You only really want one artist', 3, '3a5a0b0d-0cdc-4000-bbf4-d7eb91d0b6ff'),
('a6b73301-00f5-41f7-a3bd-f002e6f1b65d', 'Genre', '{}', '{}', 2, 'You only really want two or less genres', 4, '3a5a0b0d-0cdc-4000-bbf4-d7eb91d0b6ff'),
('3d3ceae4-b161-4c10-9420-86be360cf063', 'Adjectives', '{}', '{}', 5, 'Too many adjectives can ruin a prompt', 5, '3a5a0b0d-0cdc-4000-bbf4-d7eb91d0b6ff'),
('98822da8-4b17-4c6f-b690-5bc1f17edf33', 'Camera Angle', '{}', '{}', 1, 'You only want on camera angle', 6, '3a5a0b0d-0cdc-4000-bbf4-d7eb91d0b6ff'),
('d36c3714-00a1-4d56-97dc-e86afd9c4da9', 'Colour', '{}', '{}', 2, 'More than two colours will make no colour stand out', 7, '3a5a0b0d-0cdc-4000-bbf4-d7eb91d0b6ff'),
('ecc42c7b-de10-4c9d-809c-a9a3878d59d2', 'Lighting', '{}', '{}', 2, 'Use one lighting term for more accuracy, or two if you must', 8, '3a5a0b0d-0cdc-4000-bbf4-d7eb91d0b6ff'),
('3128fb52-66d6-4491-b1f3-ca34f43bcaba', 'Website', '{}', '{}', 2, 'You only really want two sites or it can confuse the AI', 9, '3a5a0b0d-0cdc-4000-bbf4-d7eb91d0b6ff'),
('f642d1cb-17fa-476c-8c83-d2da023b3e9d', 'Resolution', '{}', '{}', 2, 'More than two resolution keywords can confuse the generator', 10, '3a5a0b0d-0cdc-4000-bbf4-d7eb91d0b6ff'),
('cacd018c-ceee-4cdf-8c6e-bc42a202de29', 'Renderer', '{}', '{}', 1, 'Only choose one for the style', 11, '3a5a0b0d-0cdc-4000-bbf4-d7eb91d0b6ff'),
('1fbb2799-1139-44b5-afe4-2f8a3503bbc5', 'Level of Detail', '{}', '{}', 2, 'You only really want max two lod''s', 12, '3a5a0b0d-0cdc-4000-bbf4-d7eb91d0b6ff');

INSERT INTO category_value (`id`, `chunk`, `decription`, `category_id`, `image_url`, `meta_chunks`, `negative_meta_chunks`, `ai_id`) VALUES
